...
po_list=(
   ...
   "keepassxc|Управлнеие паролями|OFF|base_po"
   "dbeaver|Управление БД|OFF|prog_po"
   "docker|Контейнеры|OFF|prog_po"
   "docker-compose|Контейнеры|OFF|prog_po"
   "intellij-idea-community-edition|IDE|OFF|prog_po"
   "telegram-desktop|Тележка|OFF|base_po"
   "kate|Текстовый редактор IDE|OFF|base_po"
   "cmake|Компилятор|OFF|system_po"
   "corectrl|Управление процессором и тд|OFF|system_po"
   "pavucontrol|Управление звуком|OFF|system_po"
   "meld|Сравнение текстов|OFF|base_po"
   "kdf|NOT|OFF|base_po"
   "htop|htop|OFF|system_po"
   "psensor|Датчики|OFF|system_po"
   "lm_sensors|Датчики|OFF|system_po"
   "xsensors|Датчики|OFF|system_po"
   "yakuake|Забавные терминал|OFF|base_po"
   "blueman|Для bluetooth|OFF|system_po"
   "partitionmanager|Упавление разделами|OFF|system_po"
   "flatseal|Для flatpak|OFF|base_po"
   "filelight|Просмотр места на дисках|OFF|base_po"
   "kcalc|NOT|OFF|base_po"
   "openrgb|Управление подсветкой|OFF|system_po"
   "dolphin|Файловые менеджер|OFF|base_po"
   "koko|NOT|OFF|base_po"
   "lutris|Игровой ланучер|OFF|gamig_po"
   "inkscape|2Д графика|OFF|visual_po"
   "blender|3Д гарфика|OFF|visual_po"
   "firefox|Браузер лиса|OFF|base_po"
